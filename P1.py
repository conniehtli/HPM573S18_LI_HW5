...
print('Expected MAXIMUM reward when the probability of head is 0.5:', games.get_max_reward())
print('Expected MINIMUM reward when the probability of head is 0.5:', games.get_min_reward())
Fig.graph_histogram(
    observations=games._gameRewards,
